 ...
 * const discoverRobot = require('popp-robot-core').discoverRobot
 * const readDescriptor = require('poppy-robot-core/utils/descriptor').read
 * //
 * // create a poppy object using default connection settings for a Poppy Ergo Jr.
 * //
 * const desc = readDescriptor() // No args => use embedded descriptor for Ergo Jr
 ...
 * const desc1 = discoverRobot(connect)
