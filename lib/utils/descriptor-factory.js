 ...
 *
 * @param {module:poppy-robot-core~ConnectionSettings=} settings - connection settings. If not provided, default {@link module:poppy-robot-core~ConnectionSettings} will be used
