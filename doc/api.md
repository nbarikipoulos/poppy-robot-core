...
**Kind**: inner class of [<code>poppy-robot-core</code>](#module_poppy-robot-core)  
**See**: [module:poppy-robot-core~PoppyRequestHandler](module:poppy-robot-core~PoppyRequestHandler)  
...
| requestHandler | <code>module:poppy-robot-core~PoppyRequestHandler</code> | Poppy request handler object |
